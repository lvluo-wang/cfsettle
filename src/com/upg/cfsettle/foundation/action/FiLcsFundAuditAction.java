...
public class FiLcsFundAuditAction extends BaseAction {
	@Autowired
	 ...
	 */
	public String list(){
		List<FiLcsFund> list = fiLcsFundService.findAuditByCondition(searchBean, getPg());
	 ...
	 * 项目审核
	 * @author renzhuolun
	 * @date 2016年6月13日 下午4:21:22
	 * @return
	 */
	public void doAudit() {
		fiLcsFundService.doAuditFiLcsFund(getPKId(),status,fiLcsFund);
	}
